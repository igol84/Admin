...
import {Alert, AlertProps, Box, Select, SelectChangeEvent, Snackbar} from "@mui/material";
...
const TableExpense = () => {
  ...
  const columns: GridColumns = [
    {
      field: 'place_id', headerName: 'place Id', width: 120, editable: true,
    ...
    {field: 'date_cost', headerName: 'date Cost', width: 180, editable: true, type: "date"},
